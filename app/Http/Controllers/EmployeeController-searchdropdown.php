        ...
        if($request->get('search')==""){
            ...
            $employees = Employee::select('employees.*','departments.department_name','positions.position_name')
                  ...
                  if ($request->get('search_dropdown')=='name') {
                     ...
                     /* $employees->orwhere('dob','=',date('Y-m-d', strtotime($request->search)));  
                      $employees->orwhere('join_date','=',date('Y-m-d', strtotime($request->search)));      
                      $employees->orwhere('department_name','LIKE','%'.$request->search.'%');       
                      $employees->orwhere('position_name','LIKE','%'.$request->search.'%');   */    
               ...
               //$employees->appends($request->only('search'));
                   ...
                   $employees= $employees->appends(['search' => $request->get('search')]);
