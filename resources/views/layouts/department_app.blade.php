...
<html lang="en">
    <head>
      ...
      <!--  <script type="text/javascript" src="{{URL::asset('datepicker/libs/jqueryui/1.12.1/jquery-ui.min.js')}}"></script>
        <link rel="stylesheet" href="{{URL::asset('datepicker/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css')}}" type="text/css"/> -->    


        <!--DATEPICKER JS & CSS-->    
       <!--<script type="text/javascript" src="{{URL::asset('themes/bootstrap-datepicker.js')}}"></script>
        <script type="text/javascript" src="{{URL::asset('themes/ui/jquery-ui.js')}}"></script>

         <link rel="stylesheet" href="{{URL::asset('themes/bootstrap-datepicker.css')}}" type="text/css"/>
         <link rel="stylesheet" href="{{URL::asset('themes/bootstrap-theme.min.css')}}" type="text/css"/>
        
         <link rel="stylesheet" href="{{URL::asset('themes/ui/smoothness/jquery-ui.css')}}" type="text/css"/>
         <link rel="stylesheet" href="{{URL::asset('themes/ui/base/jquery-ui.css')}}" type="text/css"/> -->  
        <!--END DATEPICKER-->    
       ...
       <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script> 
        ...
        <link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">        
         ...
         <!-- CRUD JS -->
        <script type="text/javascript" src="{{URL::asset('js/forms/department_form.js')}}"></script>
