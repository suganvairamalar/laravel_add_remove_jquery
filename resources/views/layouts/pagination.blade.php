...
<html lang="en">
    <head>
       ...
       <!-- CRUD JS -->
       <!-- <script type="text/javascript" src="{{URL::asset('js/state_form.js')}}"></script>
       <script type="text/javascript" src="{{URL::asset('js/district_form.js')}}"></script> -->
       <script type="text/javascript" src="{{URL::asset('js/forms/author_form.js')}}"></script>
    ...
    <body>
        <div class="container">
            ...
            <div class="col-lg-12">
                        <div class="pull-left">
                             <h4>CRUD PAGINATION AND SEARCH LARAVEL/JQUERY</h4>
                        </div>
