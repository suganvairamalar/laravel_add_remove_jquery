                     ...
                     <table id="tbl_detailMark" width="100%"  border="0">
                        ...
                        <tr id="data_tr" class="data_tr">
                           ...
                           <td class="col-xs-1 col-sm-1 col-md-1 td2"><input type="text" name="total[]" id="total" class="form-control total" readonly placeholder="" />
                              <input type="text" name="max_total[]" id="max_total" class="form-control max_total" readonly placeholder="" />
                           </td>
                           <td class="col-xs-1 col-sm-1 col-md-1 td2"><input type="text" name="percentage[]" id="percentage" class="form-control percentage" readonly placeholder="" /></td>
                           <td class="col-xs-1 col-sm-1 col-md-1 td2"><input type="text" name="rank[]" id="rank" class="form-control rank" placeholder="" /></td>
         ...
         <div class="modal-content">
            ...
            <form method="post" id="edit_mark_form" class="form-horizontal edit_mark_form">
               <div class="modal-body bg-success">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-8 col-lg-8 col-xs-8 col-sm-8">
                        <select class="form-control" name="edit_student_id" id="edit_student_id">
                           <option disabled="disabled" selected="true" value="0">Select Student</option>
                           @foreach($students as $student)
                           <option value="{!!$student->id!!}">{!!$student->student_name!!}</option>
                           @endforeach
                  ...
                  <div class="form-group">
                     <label class="control-label1 col-md-4 col-lg-4 col-xs-4 col-sm-4">MARK4</label>
                     <div class="col-md-8 col-lg-8 col-xs-8 col-sm-8">
                        <input type="text" class="form-control editmark" name="edit_mark4" id="edit_mark4" placeholder="Enter a Mark4">
                     </div>
                  </div>

                  <div class="form-group">
                     <label class="control-label1 col-md-4 col-lg-4 col-xs-4 col-sm-4">MARK5</label>
                     <div class="col-md-8 col-lg-8 col-xs-8 col-sm-8">
                        <input type="text" class="form-control editmark" name="edit_mark5" id="edit_mark5" placeholder="Enter a Mark5">
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     <label class="control-label1 col-md-4 col-lg-4 col-xs-4 col-sm-4">PERCENTAGE</label>
                     <div class="col-md-8 col-lg-8 col-xs-8 col-sm-8">
                        <input type="text" class="form-control" name="edit_percentage" id="edit_percentage" readonly placeholder="Enter a percentage">
                     </div>
                  </div>
               ...
               <div class="modal-footer bg-primary">
                  ...
                  <input type="text" name="hidden_edit_student_id" id="hidden_edit_student_id" class="form-control"> 
                  <input type="text" name="hidden_edit_rank" id="hidden_edit_rank" class="form-control"> 
                  <input type="text" name="hidden_edit_total" id="hidden_edit_total" class="form-control">
                  <input type="text" name="hidden_edit_percentage" id="hidden_edit_percentage" class="form-control">
